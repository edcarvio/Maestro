...
interface MainPanelProps {
	...
	onTerminalTabCwdChange?: (tabId: string, cwd: string) => void;
	onTerminalTabPidChange?: (tabId: string, pid: number) => void;
...
export const MainPanel = React.memo(
	forwardRef<MainPanelHandle, MainPanelProps>(function MainPanel(props, ref) {
		const {
			...
			inputValue,
			enterToSendAI,
			enterToSendTerminal: _enterToSendTerminal,
			stagedImages,
			commandHistoryOpen,
			...
			setInputValue,
			setEnterToSendAI,
			setEnterToSendTerminal: _setEnterToSendTerminal,
			setStagedImages,
			setLightboxImage,
