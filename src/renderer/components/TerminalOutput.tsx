...
const LogItemComponent = memo(
	({
		...
		localFilterQuery,
		filterMode,
		activeLocalFilter: _activeLocalFilter,
		onToggleLocalFilter: _onToggleLocalFilter,
		onSetLocalFilterQuery: _onSetLocalFilterQuery,
		onSetFilterMode: _onSetFilterMode,
		onClearLocalFilter: _onClearLocalFilter,
		deleteConfirmLogId,
		onDeleteLog,
