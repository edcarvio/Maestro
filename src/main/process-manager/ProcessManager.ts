...
export class ProcessManager extends EventEmitter {
	 ...
	 * This is a simplified entry point for terminal tabs that bypasses
	 * the agent-specific logic in process:spawn.
	 *
	...
	spawnTerminalTab(config: {
		...
		logger.info('[ProcessManager] Spawning terminal tab', 'ProcessManager', {
			sessionId,
			cwd,
			shell,
			cols,
		...
		// Resize to requested dimensions after spawn
		if (result.success) {
