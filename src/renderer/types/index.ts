 ...
 * Terminal tabs cannot be fully restored since the PTY session is gone,
 * but we can recreate a new terminal in the same position.
 */
...
export interface Session {
	...
	aiPid: number;
	/**
	 * @deprecated terminalPid was always 0 (terminal used runCommand, not persistent PTY).
	 * New implementation uses terminalTabs[].pid for per-tab PTY processes.
