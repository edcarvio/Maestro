...
describe('TerminalTabRenameModal', () => {
	...
	describe('Basic Rendering', () => {
		...
		it('shows defaultName as placeholder', () => {
			render(
				<TestWrapper>
					<TerminalTabRenameModal
						theme={mockTheme}
	...
	describe('Empty Name Handling', () => {
		it('passes null when name is empty (reverts to default)', () => {
			render(
				<TestWrapper>
					<TerminalTabRenameModal
						theme={mockTheme}
			...
			expect(mockOnRename).toHaveBeenCalledWith(null);
		});

		it('passes null when name is only whitespace', () => {
			render(
				<TestWrapper>
					<TerminalTabRenameModal
						theme={mockTheme}
